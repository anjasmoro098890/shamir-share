...
from shamirshare.chain.fees import estimate_fee
from shamirshare.config import WalletConfig
from shamirshare.services.sync import SyncEngine
...
def portfolio() -> None:
    ...
    click.echo(f"coin=BTC total={total} fee_hint={fee}")
